    ...
    <>
      <header className="header-top-strip py-3">
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className="text-white mb-0">Free shipping for items over $100</p>
            </div>
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline:
                <a className="text-white" href="tel:+234-806-2456-189">+234-8062456189</a>
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="col-5">
              ...
              <div>
                <Link to= "/login" className='d-flex align-item-center gap-10 text-white'>
                  ...
                  <p className='m-0'>Log in <br />My Account</p>
                </Link>
              </div>
