...
const OurStore = () => {
  ...
  return (
    <>
      ...
      <Container class1="store-wrapper home-wraper-2 py-5">
            <div className="row">
                <div className="col-3">
                    ...
                    <div className="filter-card mb-3">
                        ...
                        <div>
                            <div className="random-products mb-3 d-flex">
                                    <div className="w-50">
                                        <img src="images/headphone2.jpg" className="img-fluid" alt="headphone" />
                                    </div>
                                    <div className="w-50">
                                        <h5>
                                            Headphone built 10 packs, multi-colour for students
                                        </h5>
                            ...
                            <div className="random-products d-flex">
                                <div className="w-50">
                                    <img src="images/watch-1.jpg" className="img-fluid" alt="headphone" />
                                </div>
                                <div className="w-50">
                                    <h5>
