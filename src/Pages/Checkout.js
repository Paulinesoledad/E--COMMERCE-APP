...
import bheadphone from '../images/bheadphone.webp';
            ...
            <div className="row">
                <div className="col-7">
                    <div className="checkout-left-data">
                        ...
                        <p className="user-details total">Ajanlekoko Yusuf (Ajanlekokoyusuf@gmail.com)</p>
                ...
                <div className="col-5">
                       ...
                       <div className="d-flex gap-10 mb-2 align-items-center">
                            <div className="w-75 d-flex gap-10">
                                <div className="w-50 position-relative">
                                    ...
                                    <img className="img-fluid" src={bheadphone} alt="Cup" />
                                </div>

                                <div>
                                    <h5 className="title total-price">Wireless Headphone Blue</h5>
                                    <p className="total-price">Authentic bass sound with sharp bluetooth connection</p>
                                </div>
                            </div>

                            <div className="flex-grow-1">
                                <h5 className="total-price">$199.99</h5>
                            </div>
                       </div>
                    </div>
                    ...
                    <div className="border-bottom py-4">
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <p className="total-price">$500.89</p>
                        </div>

                        <div className="d-flex justify-content-between align-items-center">
                            <p className="mb-0 total">Shipping</p>
                            <p className="mb-0 total-price">$99.00</p>
                        </div>
                    </div>

                    <div className="d-flex justify-content-between align-items-center border-bottom py-4">
                        <h4 className="total">Total</h4>
                        <h5 className="total-price">$599.89</h5>
                    </div>
